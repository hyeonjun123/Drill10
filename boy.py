...
class StateMachine:
    def __init__(self, boy):
        ...
        self.cur_state = Idle
        self.transitions = {
            Idle: {space_down : Idle, right_down: Run, left_down: Run, left_up: Run, right_up: Run, time_out: Sleep}, #space를 누르면 골이발사가되도록
...
class Boy:
    def __init__(self):
        ...
        self.action = 3
        self.dir = 0
        self.face_dir = 1#얼굴이 바라보는 방향을 추가함. +1 오른쪽 -1 왼쪽
